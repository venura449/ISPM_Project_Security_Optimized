...
const LoginComponent = ({ onSwitch }) => {
  ...
  return (
    <form onSubmit={handleLogin} className="space-y-5">
      <button type="button" onClick={() => { window.location.href = `${apiBase}/auth/google`; }} className="w-full border border-slate-200 bg-white text-slate-700 font-semibold py-3 rounded-2xl hover:bg-slate-50 transition inline-flex items-center justify-center gap-2">
        <svg className="h-5 w-5" viewBox="0 0 24 24" aria-hidden="true">
          ...
          <path fill="#EA4335" d="M12 6.14c1.43 0 2.71.49 3.72 1.45l2.79-2.79C16.84 3.24 14.63 2.25 12 2.25a9.75 9.75 0 0 0-8.72 5.39l3.25 2.53c.77-2.31 2.93-4.03 5.47-4.03Z" />
        </svg>
